function Hero() {
  return (
    <div className="py-[30px] md:py-[50px] xl:py-[70px] flex justify-center">
      <div className="flex flex-col justify-center items-center gap-[30px] px-6 py-[30px] md:px-0 md:pt-0 md:pb-5 xl:max-w-7xl">
        <p className="text-secondary dark:text-white text-xl leading-5 font-medium">Hola! I am Scarlet,</p>
